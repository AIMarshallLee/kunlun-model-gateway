...
本批不是完整 P0-10：外部告警通知闭环、可视化渠道轮换、更多 Key 历史的检索体验、退款风险回收/核销的完整浏览器情景及真实 IdP/MFA/入口验收仍待完成。当前告警聚合与确认已有[后续验收](OPS-ALERTS-ACCEPTANCE.md)；模型价格上下架/版本操作界面已有[独立验收](MODEL-PRICE-ACCEPTANCE.md)。客户资料与风险原因只可交付给获授权运营者。
