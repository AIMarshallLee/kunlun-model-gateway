...
def run_migrations_offline() -> None:
    url = os.getenv("KUNLUN_DATABASE_URL") or config.get_main_option("sqlalchemy.url")
...
def run_migrations_online() -> None:
    ...
    configuration["sqlalchemy.url"] = os.getenv("KUNLUN_DATABASE_URL") or configuration["sqlalchemy.url"]
